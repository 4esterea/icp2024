...
bool CollisionChecker::CheckCollisionRectangleRectangle(IRectangleCollider * cr1, IRectangleCollider * cr2) {
    ...
    r1p[2][0] = p1->x + w1 * cos((360 - p1->angle) * PI / 180) + -h1/2 * sin((360 - p1->angle) * PI / 180);
    r1p[3][0] = p1->x + -h1/2 * sin((360 - p1->angle) * PI / 180);
    r1p[0][1] = p1->y + h1/2 * cos((360 - p1->angle) * PI / 180);
